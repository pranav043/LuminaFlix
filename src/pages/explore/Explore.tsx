...
const Explore = () => {
    ...
    const fetchInitialData = () => {
        setLoading(true);
        tmdbApi(`/discover/${mediaType}`, filters).then((res) => {
            setData(res);
    ...
    const onChange = (selectedItems, action) => {
        if (action.name === "sortby") {
            ...
            if (action.action !== "clear") {
                (filters as any).sort_by = selectedItems.value;
            } else {
                delete (filters as any).sort_by;
            }
        }
        ...
        if (action.name === "genres") {
            ...
            if (action.action !== "clear") {
                ...
                (filters as any).with_genres = genreId;
            } else {
                delete (filters as any).with_genres;
            }
        }
                ...
                <div className="pageHeader">
                    ...
                    <div className="filters">
                        <Select
                            ...
                            options={(genresData as any)?.genres}
